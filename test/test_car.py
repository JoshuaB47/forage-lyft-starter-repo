# has not been updated for the tire specifications

# import unittest
# from datetime import datetime
# # relative paths are working weirdly
# import sys
# sys.path.insert(0, sys.path[0] + '/../')

# from New_Design.car_factory import CarFactory
...
#         last_service_mileage = 0
#         # mileage too high, though was replaced today
...
# # original test case here was wrong, since Palindromes use Spindlers
# # not Nubbins
